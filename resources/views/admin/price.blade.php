                    ...
                    <tr class="user-row">
                        ...
                        <td>
                            <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                data-bs-target="#editPrice-{{ $d->id }}">
                                <i data-id="{{ $d->id }}" data-feather="edit"></i>
                            </button>

                            <!-- Modal -->
                            <div class="modal fade" id="editPrice-{{ $d->id }}" tabindex="-1"
                                aria-labelledby="editPriceLabel-{{ $d->id }}" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="editPriceLabel-{{ $d->id }}">Edit Today's
                                                Price</h5>
                                        ...
                                        <div class="modal-body">
                                            <form action="{{ route('updatePrice') }}" method="POST">
                                                ...
                                                <input type="number" name="price" placeholder="Update Price"
                                                    class="form-control" value="{{ $d->price }}">
                                        </div>
                                        <div class="modal-footer">
